...
public class ProfileWriteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                task.execute("http://" + IP_ADDRESS + "/profile.php", name,birthday,email,sex);
            }
        });
    ...
    class InsertData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ProfileWriteActivity.this,
        ...
        protected String doInBackground(String... params) {
            ...
            String postParameters = "name=" + name + "&birthday=" + birthday+ "&email=" + email+"&sex=" + sex;
