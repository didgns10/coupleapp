...
//            Log.e("params[1] : ", params[1].toString());
    ...
    private void showResult() {
        ...
        try {
            ...
            AlbumData albumData = new AlbumData();
            String newtitle = "앨범추가";
            String newimg = "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTusK7hTTGXp94sKvor2T9fAlFBBSB840L4q4VnBOilHLMM_AhR";
            albumData.setAlbumtitle(newtitle);
            albumData.setAlbumtitleimg(newimg);
