...
public class DiaryAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleDateFormat simpleDate1 = new SimpleDateFormat("HH:mm");
        date = simpleDate.format(mDate);
        time = simpleDate1.format(mDate);
        ...
        bt_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(title.equals("") || date.equals("") || content.equals("")){
                    Toast.makeText(DiaryAddActivity.this,"빈칸없이 입력해주세요",Toast.LENGTH_SHORT).show();
                }else{
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(DiaryAddActivity.this,
