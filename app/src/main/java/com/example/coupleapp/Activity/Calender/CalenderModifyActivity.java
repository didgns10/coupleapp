...
public class CalenderModifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calender_modify);
        ...
        et_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(CalenderModifyActivity.this, myDatePicker, myCalendar.get(Calendar.YEAR),
        ...
        bt_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                task.execute( "http://" + IP_ADDRESS + "/alarm_update.php?couple_idx="+couple_idx+"&idx="+idx+"&new_title="+new_title+"&new_date="+new_date, "");
            }
        });
    }
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(CalenderModifyActivity.this,
...
//                mTextViewResult.setText(errorString);
                ...
                mJsonString = result;
                if(result.equals("2")){
                    Toast.makeText(CalenderModifyActivity.this,"일정을 수정했습니다",Toast.LENGTH_SHORT).show();
