...
public class GoogleMapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                Toast.makeText(GoogleMapActivity.this, "마커를 클릭하세요", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                Intent intent = new Intent(GoogleMapActivity.this, DatecouseActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.putExtra("lat",latitude+"");
                intent.putExtra("long",longt+"");
                intent.putExtra("site",getCurrentAddress(latLng1));
    ...
    public void setDefaultLocation() {
        ...
        //디폴트 위치, Seoul
        LatLng DEFAULT_LOCATION = new LatLng(37.484103063360365, 126.97367727756499);
